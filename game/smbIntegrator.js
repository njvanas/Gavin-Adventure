(function () {
    function stepGavin(player, input, deltaMs) {
        ...
        const DEFAULT_G = S.DEFAULT_GRAVITY;
        ...
        function applyJumpImpulse() {
            ...
            if (window.audio && window.audio.playSound) window.audio.playSound('jump');
        }
        ...
        if (vx > 0.08) player.smbFacing = 0;
        else if (vx < -0.08) player.smbFacing = 1;
